...
module Trailblazer
  class Endpoint
    ...
    class Protocol < Trailblazer::Activity::Railway
      ...
      def self.insert_find_process_model!(protocol)
      ...
      class FindProcessModel < Activity::Railway
        step :find_process_model?, Output(:failure) => Id("End.success")
        step :find_process_model#,  Output(:failure) => End(:not_found) # DISCUSS: {End.failure} currently implies {not_found}.
